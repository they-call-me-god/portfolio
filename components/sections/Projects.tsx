...
function DepthCard({ project, index, posthog }: { project: typeof PROJECTS[0]; index: number; posthog: ReturnType<typeof usePostHog> }) {
  ...
  // Alternate cards: enter from left vs right in 3D
  ...
  return (
    <div ref={ref} style={{ perspective: '1400px' }}>
      ...
      >
        <div className="relative h-full bg-zinc-900/90 border border-zinc-800 rounded-3xl p-8 overflow-hidden transition-colors duration-300 group-hover:border-red-800/50 backdrop-blur-sm flex flex-col gap-4 min-h-[260px]">
